...
class DualExponential(bp.dyn.TwoEndConn):
	def __init__(self, pre, post, conn, g_max=1., tau_decay=10.0, tau_rise=1., delay_step=2, E=0.,
...
run_syn(DualExponential, syn_type='CUBA', title='Exponential Synapse Model (Current-Based)')
run_syn(DualExponential, syn_type='COBA', title='Exponential Synapse Model (Conductance-Based)', E=0.)
